...
const Contact = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      <Header />
      <main className="flex-1 bg-gradient-to-br from-healthbridge-light to-white">
          ...
          >
            ...
            <div className="grid md:grid-cols-5 gap-8 bg-white rounded-2xl shadow-xl overflow-hidden">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    ...
                    <div>
                      <label htmlFor="email" className="block text-sm font-medium text-gray-700 mb-1">
                        {t('email_contact_placeholder')}
                      </label>
                      <Input 
                        id="email"
                        type="email"
                        required
                        placeholder={t('email_contact_placeholder')}
                      />
                    </div>
                  </div>
                  <div>
              ...
              <motion.div 
                ...
                className="md:col-span-2 bg-healthbridge-blue text-white p-8 flex flex-col justify-between"
              >
                <div>
                    ...
                    <div className="flex items-start space-x-4">
                      ...
                      <div>
                        ...
                        <p className="mt-1 text-white/80">
                          HealthBridge Foundation<br />
                          723 Innovation Drive<br />
